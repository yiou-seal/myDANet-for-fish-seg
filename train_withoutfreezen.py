...
if __name__ == "__main__":
    ...
    model_path = '/home/xx316/zth/deeplabv3-plus-pytorch-main/imagenetpertrained_shujzengyi_excludenofish_lr1e_3_logs/ep105-loss0.015-val_loss0.017.pth'
    #---------------------------------------------------------#
    #   下采样的倍数8、16 
    ...
    savemodepath='imagenetpertrained_shujzengyi_excludenofish_lr1e_3_follow_logs/'
