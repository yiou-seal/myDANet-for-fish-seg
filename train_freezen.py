...
if __name__ == "__main__":
    ...
    savemodepath='imagenetpertrained_shujzengyi_excludenofish_freezenbackbone_logs/'
    ...
    #------------------------------------------------------#
    train_dataset = deepfishDataset(True, input_shape, dataset_path, resizescale, num_classes)
    val_dataset = deepfishDataset(False, input_shape, dataset_path, resizescale, num_classes)
    ...
    if True:
        ...
        lr = Unfreeze_lr
        start_epoch = Freeze_until_Epoch
        end_epoch = UnFreeze_and_until_Epoch
        ...
        for epoch in range(start_epoch, end_epoch):
            newvalloss = fit_one_epoch(model_train, model, loss_history, optimizer, epoch,
                                       epoch_step, epoch_step_val, gen, gen_val, end_epoch, Cuda, dice_loss, focal_loss,
                                       cls_weights, num_classes, savemodepath, minvalloss)
            lr_scheduler.step()
            if newvalloss < minvalloss:
                minvalloss = newvalloss
