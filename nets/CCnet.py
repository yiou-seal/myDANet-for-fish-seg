...
BatchNorm2d = nn.BatchNorm2d#functools.partial(InPlaceABNSync, activation='identity')
...
class ResNet(nn.Module):
    ...
    def forward(self, x, labels=None):
        ...
        # outs = [x, x_dsn]
        x = F.interpolate(x, size, mode='bicubic', align_corners=True)
        outs=x
        #print(outs)
...
def CCnetSeg_Model(num_classes, criterion=None, pretrained_model=None, recurrence=2, **kwargs):#recurrence表示用几遍cca模块
