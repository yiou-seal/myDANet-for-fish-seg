...
class deepfishDataset(Dataset):
    ...
    def __init__(self, is_train, crop_size, image_dir,resizescale,numclass):
        ...
        features, labels = self.read_deepfish_images(image_dir, resizescale,is_train=is_train)
    ...
    def __getitem__(self, idx):
        ...
        return self.processfeaturelabel(self.features[idx], self.labels[idx])
