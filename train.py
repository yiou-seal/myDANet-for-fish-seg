...
if __name__ == "__main__":
    ...
    model = DANetwp(nclass=num_classes, backbone='resnet50',baseisperTrain=False)
    if not pretrained:
        weights_init(model)
    if model_path != '':
        #------------------------------------------------------#
    ...
    if True:
        ...
        train_dataset   = deepfishDataset(True, input_shape,  VOCdevkit_path,resizescale,num_classes)
        val_dataset     = deepfishDataset(False, input_shape, VOCdevkit_path, resizescale, num_classes)
